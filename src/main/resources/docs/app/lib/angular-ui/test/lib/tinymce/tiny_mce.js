(function (e) {
    ...
    var c = {
        majorVersion: "3", minorVersion: "5.6", releaseDate: "2012-07-26", _init: function () {
    ...
    function g() {
        ...
        function L(ad) {
            ...
            tinymce.each(V, function (ag, ae) {
                ...
                if (!af) {
                    af = p.add(O.documentElement, "div", {
                        id: "mceResizeHandle" + ae,
                        "class": "mceResizeHandle",
                        style: "cursor:" + ae + "-resize; margin:0; padding:0"
                    });
                ...
                p.setStyles(af, {
                    left: (ac * ag[0] + I) - (af.offsetWidth / 2),
                    top: (aa * ag[1] + H) - (af.offsetHeight / 2)
                })
            });
